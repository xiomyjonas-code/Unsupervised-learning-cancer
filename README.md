...
* `rna_cancer/`: carpeta con los archivos `data_8000.csv` (Matriz de expresión génica, en formato .zip es necesario descomprimir el archivo) y `labels.csv` (etiquetas reales)
